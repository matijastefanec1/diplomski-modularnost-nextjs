...
function match(teamAPoints: number, teamBPoints: number, winningSide: MatchSide) {
  return {
...
function basePointsOf(playerId: string, awards: readonly { playerId: string; basePoints: number }[]) {
